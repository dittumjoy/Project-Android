...
import com.app.thoughtsharing.Adapters.MyclassListAdapter;
...
public class MyClassesFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mParseObjects= ThoughtSharingApp.getInstance().getmParseObject();
    ...
    public void addclasses(String s)
    {
        if(s.equals("added"))
        {
            ...
            query.whereEqualTo("Owner", ThoughtSharingApp.getInstance().getmUsernamae());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter=new MyclassListAdapter(getActivity(), mParseObjects);
        if(mParseObjects!=null) {
            if(mParseObjects.size()>0)
